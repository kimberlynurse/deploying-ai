...
vector_db_client_url="https://docs.trychroma.com/docs/run-chroma/clients#python"
client = chromadb.PersistentClient(path="./pitchfork_reviews")
collection = client.create_collection(name="pitchfork_reviews", 
